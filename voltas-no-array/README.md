...
R: Para rodar o script/sistema, basta iniciar uma IDE de codificação e executar o arquivo. O Script foi escrito em Javascript, caso não consiga rodar em sua IDE utilize o VSCODE.
Como o script/sistema não necessita de uma entrada de dados, apenas rodando-o conseguimos verificar na saída do console o resultado da operação. 

Obs: Não consegui finalizar, mas busquei tentar em outra linguagem sem ser java para facilitar na lógica. 